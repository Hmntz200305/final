...
from app.config_flask import SECRET_KEY, UPLOAD_FOLDER, QRCode_FOLDER, server_ip
...
api.add_resource(ReturnSubmited, '/api/getdata-returnsubmited')
api.add_resource(ReturnDecline, '/api/returndecline/<int:selectedTicketId>')
api.add_resource(ReturnApprove, '/api/returnapprove/<int:selectedTicketId>')
