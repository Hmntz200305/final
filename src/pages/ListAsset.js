    ...
    return (
      <>
        <div className='flex flex-col p-2'>
          <p className='mb-4'>Please download the data import template first:
          ...
          <Button className='bg-gray-800 mt-2' onClick={handleFileUpload} disabled={isLoading}>{isLoading ? 'Uploading...' : 'Upload'}</Button>
        </div>
      </>
    )
  }
    ...
    <>
      <div className='p-2'>
        <div className='bg-gray-800 mb-8 rounded-2xl p-4 shadow'>
          <h2 className='text-white'>Welcome, List of Asset page:)</h2>
        </div>
        {Role === 2 || Role === 1 ? (
          ...
          <div className='p-2'>
            <div className='bg-white rounded-2xl shadow p-4 space-y-4'>
              ...
              <div className='flex gap-1 justify-end'>
                ...
                <Button type="button" className='bg-green-500 hover:bg-green-600 shadow-none' id="edit-button" onClick={() => editAsset(token)}>Edit Asset</Button>
              </div>
            </div>
          </div>
        </Modal>
        ...
        >
          <div className='p-2 bg-[#efefef] flex justify-center items-center flex-col'>
            ...
            <div className='flex mt-4 space-x-4'>
              <Button className='border border-gray-300 bg-transparent text-gray-800 hover:bg-gray-200 shadow-none' onClick={closeModalQr}>CLose</Button>
              <Button className=' bg-gray-800 hover:bg-gray-900 shadow-none' onClick={() => handleDownloadQRCode(QRCodePath, QRCodeName)}>Download</Button>
            </div>
          </div>
        </Modal>
      )}
          ...
          <div className='p-2'>
            <div className="flex flex-col items-center justify-center bg-white p-2 shadow-xl rounded-2xl">
              ...
              <div className="flex space-x-4 mt-5">
                ...
                <Button className="bg-red-500 hover:bg-red-600 shadow-none" onClick={() => deleteAsset(selectedAssetId)}>
                  Delete
                </Button>
              </div>
            </div>
